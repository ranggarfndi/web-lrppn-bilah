{{-- File: resources/views/layouts/navigation.blade.php (Logo Dihilangkan) --}}
                ...
                <div class="hidden space-x-4 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        ...
                        @elseif(Auth::user()->role == 'pasien')
                            <x-nav-link-pill :href="route('pasien.riwayat.show')" :active="request()->routeIs('pasien.riwayat.show')">
                                {{ __('Riwayat Saya') }}
                            </x-nav-link-pill>
                        @endif
                    @endauth
    ...
    @auth
        <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                ...
                @if (Auth::user()->role == 'admin')
                    <x-responsive-nav-link :href="route('admin.pasien.index')" :active="request()->routeIs('admin.pasien.*', 'admin.soap.*', 'admin.likert.*')"
                        class="text-gray-600 hover:text-gray-900 hover:bg-gray-50"
                        active-class="bg-indigo-50 border-l-4 border-indigo-400 text-indigo-700 font-semibold">
                        {{ __('Manajemen Pasien') }}
                    </x-responsive-nav-link>
            ...
            <div class="pt-4 pb-1 border-t border-gray-200">
                ...
                <div class="mt-3 space-y-1">
                    <x-responsive-nav-link :href="route('profile.edit')" class="text-gray-600 hover:text-gray-900 hover:bg-gray-50"
                        active-class="bg-indigo-50 border-l-4 border-indigo-400 text-indigo-700 font-semibold">
                        {{ __('Profile') }}
                    </x-responsive-nav-link>
