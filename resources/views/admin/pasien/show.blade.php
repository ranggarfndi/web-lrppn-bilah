<x-app-layout>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // === LOGIKA CHART ===
            // Kita panggil endpoint ADMIN untuk data chart
            ...
            searchInput.addEventListener('keyup', function () {
                ...
                if (searchTerm.length > 0) {
                    ...
                    // Sembunyikan semua pesan kosong saat mencari
                    emptyMessages.forEach(msg => msg.style.display = 'none');
                } else {
                    resultsCount.style.display = 'none';
                    // Kembalikan pesan kosong jika tidak ada item di list tersebut
                    // (Logic sederhana: biarkan default blade menangani empty state awal)
